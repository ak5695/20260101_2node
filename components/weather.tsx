...
export function Weather({
  ...
  if (!weatherAtLocation?.hourly?.temperature_2m || !weatherAtLocation.current || !weatherAtLocation.daily) {
    return <div className="p-4 text-sm text-muted-foreground">Weather data currently unavailable.</div>;
  }
