  ...
  try {
    ...
    const stream = createUIMessageStream({
      ...
      execute: async ({ writer: dataStream }) => {
        console.log("Executing stream logic...");
      ...
      onFinish: async ({ messages: finishedMessages }) => {
        console.log("Stream finished. Saving messages count:", finishedMessages.length);
        try {
          if (isToolApprovalFlow) {
      ...
      onError: (error) => {
        console.error("Stream onError triggered:", error);
