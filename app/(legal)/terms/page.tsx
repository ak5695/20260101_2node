        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-zinc-300 leading-relaxed">
              By accessing or using our AI Chatbot service ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of the terms, you may not access the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold mb-3 text-indigo-400">2.1 Eligibility</h3>
            ...
            <h3 className="text-xl font-semibold mb-3 text-indigo-400">2.2 Account Registration</h3>
            <p className="text-zinc-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-indigo-400">2.3 Guest Access</h3>
            <p className="text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold mb-3 text-indigo-400">4.1 Your Content</h3>
            <p className="text-zinc-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 text-indigo-400">4.2 Content Responsibility</h3>
            <p className="text-zinc-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6 text-indigo-400">4.3 AI-Generated Content</h3>
            <p className="text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold mb-3 text-indigo-400">6.1 Billing</h3>
            <p className="text-zinc-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 text-indigo-400">6.2 Automatic Renewal</h3>
            <p className="text-zinc-300 leading-relaxed mb-4">
              Subscriptions automatically renew unless you cancel before the renewal date. You will be charged at the then-current rate.
            </p>

            <h3 className="text-xl font-semibold mb-3 text-indigo-400">6.3 Cancellation</h3>
            <p className="text-zinc-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold mb-3 text-indigo-400">6.4 Refunds</h3>
            <p className="text-zinc-300 leading-relaxed">
              Please refer to our <Link href="/refund" className="text-indigo-400 hover:text-indigo-300 underline">Refund Policy</Link> for information about refunds.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-[#1a1a1a] border border-white/10 rounded-lg p-6">
              <p className="text-zinc-300">Email: legal@example.com</p>
